...
Goals (high level intended outcomes; for software, a Product Backlog)/<br>Boundaries / Scope (where the functions and responsibilities of the solution start and end / what it should do and what is left to other systems to do)
